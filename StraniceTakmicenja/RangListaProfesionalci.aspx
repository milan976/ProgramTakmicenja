<%@ Page Title="Rang Lista - Profesionalci" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RangListaProfesionalci.aspx.cs" Inherits="ProgramTakmicenja.StraniceTakmicenja.RangListaProfesionalci" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="breadcrumb no-print">
            ...
            <strong>Професионалци - Ранг листа</strong>
        </div>
        
        <!-- Naslov i dugme za štampu -->
        <div class="clearfix">
            <h1 class="page-title">Ватрогасни Савез Србије<br/>
            <small>Ранг листа - Професионалци</small></h1>
        ...
        <div class="tab-container no-print">
            <div class="tab-buttons">
                <asp:LinkButton ID="lnkPBMuski" runat="server" 
                    CssClass="tab-button active" 
                    OnClick="lnkPBMuski_Click">
                    <i class="fas fa-mars" style="margin-right: 5px;"></i>Професионалне Б - Мушка
                </asp:LinkButton>
                
                <asp:LinkButton ID="lnkPBZenski" runat="server" 
                    CssClass="tab-button" 
                    OnClick="lnkPBZenski_Click">
                    <i class="fas fa-venus" style="margin-right: 5px;"></i>Професионалне Б - Женске
                </asp:LinkButton>
                
                <asp:LinkButton ID="lnkPAMuski" runat="server" 
                    CssClass="tab-button" 
                    OnClick="lnkPAMuski_Click">
                    <i class="fas fa-mars" style="margin-right: 5px;"></i>Професионалне А - Мушка
                </asp:LinkButton>
                
                <asp:LinkButton ID="lnkPAZenski" runat="server" 
                    CssClass="tab-button" 
                    OnClick="lnkPAZenski_Click">
                    <i class="fas fa-venus" style="margin-right: 5px;"></i>Професионалне А - Женске
                </asp:LinkButton>
            </div>
        </div>
        ...
        <div class="print-optimized">
            <asp:GridView ID="GridViewProfesionalci" runat="server" 
                CssClass="rang-table" 
        ...
        <div style="margin-top: 30px; font-size: 10pt; text-align: center;" class="no-print">
            ...
            Категорија: <asp:Label ID="lblTrenutnaKategorija" runat="server" Text="Професионалци класа Б - Мушка" />
        </div>
    </div>
