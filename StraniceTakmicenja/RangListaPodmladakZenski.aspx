<%@ Page Title="Rang Lista - Podmladak" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RangListaPodmladakZenski.aspx.cs" Inherits="ProgramTakmicenja.StraniceTakmicenja.RangListaPodmladakZenski" %>
    ...
    <div class="container">
       ...
       <!-- Rang lista -->
        <div class="print-optimized">
            <asp:GridView ID="GridViewPodmladakZenski" runat="server" CssClass="rang-table" AutoGenerateColumns="false" ShowHeader="true">
                <Columns>
